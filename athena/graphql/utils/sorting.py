...
from athena.graphql.core.utils.utils import from_global_id_or_error
...
def sort_queryset(queryset, sort_by, reversed):
...
def sort_queryset_by_default(queryset, reversed):
